...
if tr_rs.recordcount>0 then
  Titolo_1=tr_rs("Titolo_1_en")
  Titolo_2=tr_rs("Titolo_2_en")
  Url=tr_rs("Url_en")
  Title=tr_rs("Title_en")
  Description=tr_rs("Description_en")
  Descrizione=tr_rs("Descrizione_en")
  Img=tr_rs("Img")
...
<head>
    ...
    <meta property="og:description" content="<%if Len(Description)>0 then%><%=Description%><%else%>Search the online catalog of <%=Titolo_1%>, <%=Titolo_2%>: from Cristalensi discounts on all lighting products for sale.<%end if%>">
    ...
    <div class="container content">
        ...
        <div class="col-md-9">
            <div class="row top-buffer">
                ...
                sql = "SELECT * FROM Prodotti WHERE ((FkNewTipologia="&pkid_tipologia&") and (Offerta=0 or Offerta=2) and (Len(Titolo_EN)>0)) ORDER BY "&ordine&""
