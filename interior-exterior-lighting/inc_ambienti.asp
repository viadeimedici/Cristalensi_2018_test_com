    ...
    <div class="container content">
            ...
            <div class=" top-buffer">
                <nav class="navbar hidden-xs">
                    ...
                    <ul class="list-unstyled side-list">
                        ...
                        %>
                        <li><a href="/interior-exterior-lighting/<%=Url%>" title="<%=Titolo_1%>" <%if pkid=pkid_ambiente then%>class="active"<%end if%>><%=Titolo_1%></a></li>
                        <%
                        tip_rs.movenext
                        loop
                        %>
        ...
        <div class="col-md-9">
            <div class="row top-buffer">
                ...
                sql = "SELECT * FROM Prodotti WHERE ((FkNewAmbiente LIKE '%"&PosizioneAmbiente&"%') and (Offerta=0 or Offerta=2) and (Len(Titolo_EN)>0)) ORDER BY "&ordine&""
