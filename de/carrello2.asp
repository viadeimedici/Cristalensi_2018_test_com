...
<%
	...
	if mode=1 and TipoCostoTrasportoScelto<10 then response.Redirect("/de/carrello3.asp")
	if mode=1 and TipoCostoTrasportoScelto=10 then response.Redirect("/de/carrello2extra.asp")
...
<head>
    ...
    <style type="text/css">
		...
		function Cambia()
		{
			 ...
			 document.modulocarrello.action = "/de/carrello2.asp";
		...
		function Continua()
		{
		 ...
		 <%end if%>
			 ...
			 document.modulocarrello.method = "post";
			 document.modulocarrello.action = "/de/carrello2.asp?mode=1";
			 document.modulocarrello.submit();
		}
		</script>
                        ...
                        <table id="cart" class="table table-hover table-condensed table-cart">
                            ...
                            <tbody>
														...
														if trasp_rs.recordcount>0 then
															...
															NomeSpedizione=trasp_rs("nome_DE")
															DescrizioneSpedizione=NoLettAccDescrizioni(trasp_rs("descrizione_DE"))
                ...
                <div class="bg-primary">
                    ...
                    <%end if%>
	                 	&#8364;&nbsp;</b></p>
								...
								<%if rs.recordcount>0 then%>
                <a href="/de/carrello1.asp" class="btn btn-danger pull-left" style="margin-top: 10px;"><i class="glyphicon glyphicon-chevron-left"></i> Vorhergehender Schritt</a>
                <%if TipoTrasportoScelto>0 then%><a href="#" class="btn btn-danger pull-right" onClick="Continua();" style="margin-top: 10px;">klicken Sie hier, um den Einkauf abzuschliessen <i class="glyphicon glyphicon-chevron-right"></i></a><%end if%>
								<%end if%>
            </div>
						<%end if%>
        </div>
