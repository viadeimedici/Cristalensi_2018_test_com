        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="top-buffer">
                    ...
                    <p>
											Vielen Dank,<br />dass Sie unsere Produkte gewahlt haben, es wurde eine Speditionskostenanfrage an unsere Mitarbeiter abgeschickt,<br />um die Bestellung n. <%=idordine%> beenden zu konnen.<br />
							    <br />
								 Innerhalb der nachsten Stunden (max 24h) werden Sie per e-mail eine Meldung erhalten, die Ihnen die Moglichkeit gibt, Ihre Bestellung zu beenden.<br />Nun mussen Sie bitte nochmals Login und Passwort in unserem Kundenbereich auf der Startseite eingeben, danach klicken Sie auf "meine Bestellungen" und dann klicken Sie auf Ihre angefangene Bestellung.<br />Um Ihre Bestellung nun endgultig abschliessen zu konnen, brauchen Sie nur noch Ihren Zahlungswunsch <br />einzugeben:Bankuberweisung oder Kreditkarte oder vorbezahlter Karte.
							    <br /><br /><br />
