...
<head>
		<meta charset="utf-8">
		<title>Cristalensi - Liste der Lieblingsprodukte</title>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:20%"></th>
																...
																<tbody>
																		...
																		%>
																		<form method="post" action="/de/preferiti.asp?mode=1&riga=<%=rs("pkid")%>">
																		<tr>
                                        <td data-th="Product" class="cart-product">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h5 class="nomargin"><a href="<%=NomePagina%>" title="Produkt: <%=NomePagina%>"><%=rs("titolo")%></a></h5>
                                        ...
                                        <td class="actions" data-th="">
                                            ...
                                            <button class="btn btn-info btn-sm" type="button" onClick="location.href='<%=NomePagina%>'"><i class="fa fa-shopping-cart"></i></button>
																	...
																	<tfoot>
	                                    <tr>
	                                        <td><a href="<%=fromURL_preferiti%>" class="btn btn-warning"><i class="fa fa-angle-left"></i> Mit dem Einkaufen fortfahren</a></td>
																...
																<%else%>
																	...
																	<tr>
																			<td data-th="Product" class="cart-product">
																					<div class="row">
																							<div class="col-sm-12">
																									<h5 class="nomargin"><br>Kein Produkt auf der Wunschliste</h5>
																							</div>
																			</td>
																	</tr>
																	</tbody>
