...
<!--#include virtual="/cStripeFunctions.asp"-->
<%
	...
	if idOrdine=0 then response.redirect("/de/carrello1.asp")
	...
	if FkPagamento=1 or FkPagamento=5 then
		...
		rs.close
			...
			Oggetto = "Conferma invio ordine n "&idordine&"/COM a Cristalensi.com (tedesco) con pagamento con bonifico bancario"
			Testo = HTML1
	...
	if FkPagamento=3 then
		...
		rs.close
			...
			Mittente = "info@cristalensi.it"
			Destinatario = "info@cristalensi.it"
			Oggetto = "Conferma invio ordine n "&idordine&"/COM (tedesco) a Cristalensi.com con pagamento in contrassegno"
			Testo = HTML1
	...
	if FkPagamento=4 then
		...
		rs.close
			...
			Mittente = "info@cristalensi.it"
			Destinatario = "info@cristalensi.it"
			Oggetto = "Conferma invio ordine n "&idordine&"/COM (tedesco) a Cristalensi.com con pagamento con POSTEPAY"
			Testo = HTML1
...
<body>
  ...
  <!--#include virtual="/de/inc_header_2.asp"-->
    <div class="container content">
        ...
        <div class="col-md-12">
						<div class="title">
								<h4>Bestellung n. <%=idordine%> - Datum <%=Left(DataAggiornamento, 10)%></h4>
						</div>
						<div class="col-md-12 hidden-print">
						<%if FkPagamento=1 or FkPagamento=5 then%>
								<p class="description">
									Vielen Dank, dass Sie unsere Produkte gewahlt haben,<br />um die Bestellung zu vervollstandigen, mussen Sie nun eine Bankuberweisung mit den folgenden Daten ausfuhren:<br>
										<br>
										...
										<br><br>als Zahlungsgrund geben Sie bitte an: "<strong>Bestellung n&deg; <%=idordine%></strong> aus dem Internet"<br><br>
                                    Begunstigter: <strong>Cristalensi Snc di Lensi Massimiliano & C. (P.Iva e C.Fiscale 05305820481)<br>
                             Via arti e mestieri, 1 - 50056 Montelupo F.no (Florenz) Italien</strong>
										<br><br>
										Unsere Mitarbeiter werden Ihnen die Ware zuschicken, sobald wir von der Bank die Nachricht erhalten haben, dass Ihre uberweisung bei uns eingegangen ist. Um die Lieferung zu beschleunigen, konnen Sie uns auch eine e-mail mit der Kopie der Bankuberweisung schicken (bei Homebanking wird meistens von der Bank eine Bestatigung mitgeliefert oder Sie scannen die Bestatigung Ihrer Bank ein).<br>
										<br>
										In dem Moment in dem Sie zahlen, beenden Sie Ihre Bestellung, und damit akzeptieren Sie unsere Verkaufsbedingungen.<br>Speichern Sie oder drucken Sie hier unsere Verkaufsbedingungen (diese konnen auch auf der entsprechenden Seite unserer Internetseite eingesehen werden):<br>
                                  <a href="condizioni_di_vendita.pdf" target="_blank">Verkaufsbedingungen</a>
										<br><br>
										<strong>WIR SENDEN AUCH ALLE DATEN PER EMAIL ZUR ZAHLUNG</strong>
										<br>
										<br>
						...
						<%if FkPagamento=4 then%>
								<p class="description">
										<br><br>Vielen Dank, dass Sie unsere Produkte gewahlt haben,<br />
                                    um die Bestellung zu vervollstandigen, mussen Sie nun eine uberweisung auf die POSTEPAY Karte mit den folgenden Daten ausfuhren:<br>
											<br><br>
											<strong>Begunstigter: LENSI GIULIANO - c.f. LNS GLN 42A30 D403J<br>
											Kartennummer: 5333 1710 7681 8950</strong>
											<br><br>als Zahlungsgrund geben Sie bitte an: "<strong>Bestellung n&deg; <%=idordine%> aus dem Internet</strong>"<br><br>
											As the cause of payment please indicate: "<strong>Order from web site n&deg; <%=idordine%></strong>"<br><br>
                                    Die Ware wird Ihnen zugeschickt, sobald sie in unserem Magazin vorratig ist. Bitte denken Sie daran, dass bei der Zahlung per Nachnahme, der Kurier die Ware nur gegen Barzahlung ausliefert, er wird keine andere Bezahlungsart akzeptieren (auch keine Schecks).
                                  <br><br>
                                   In dem Moment in dem Sie zahlen, beenden Sie Ihre Bestellung, und damit akzeptieren Sie unsere Verkaufsbedingungen. Speichern Sie oder drucken Sie hier unsere Verkaufsbedingungen (diese konnen auch auf der entsprechenden Seite unserer Internetseite eingesehen werden):<br><a href="condizioni_di_vendita.pdf" target="_blank">Verkaufsbedingungen</a>
										<br /><br />
										<strong>WIR SENDEN AUCH ALLE DATEN PER EMAIL ZUR ZAHLUNG</strong>
										<br>
										<br>
						...
						<%if FkPagamento=3 then%>
								<p class="description">
									<br><br>Vielen Dank, dass Sie unsere Produkte gewahlt haben,<br>
                    Die Ware wird Ihnen zugeschickt, sobald sie in unserem Magazin vorratig ist.<br>
                    Bitte denken Sie daran, dass bei der Zahlung per Nachnahme, der Kurier die Ware nur gegen Barzahlung ausliefert, er wird keine andere Bezahlungsart akzeptieren (auch keine Schecks).<br>
                    <br>
                  In dem Moment in dem Sie zahlen, beenden Sie Ihre Bestellung, und damit akzeptieren Sie unsere Verkaufsbedingungen. Speichern Sie oder drucken Sie hier unsere Verkaufsbedingungen (diese konnen auch auf der entsprechenden Seite unserer Internetseite eingesehen werden):<br>
                  <a href="condizioni_di_vendita.pdf" target="_blank">Verkaufsbedingungen</a>
                  <br>
                  <br>
                  Herzliche Grusse, Ihr Team von Cristalensi.
                  ...
                  <br>
						...
						<%if FkPagamento=6 then%>
							<div class="col-md-12">
							<p class="description">
								Vielen Dank, dass Sie unsere Produkte gewahlt haben,<br>
							    um die Bestellung zu vervollstandigen, mussen Sie nun uber das sichere Paypal System zahlen, Sie konnen dies mit diversen Kreditkarten und wiederaufladbaren Karten tun:
	                    ...
	                    <div class="col-md-12" style="padding-top: 20px;">
													<div class="form-group clearfix">
															<label for="nominativo" class="col-sm-6 control-label">Kartennummer</label>
															<div class="col-sm-6">
													...
													<div class="form-group clearfix">
															<label for="cod_fisc" class="col-sm-6 control-label">Haltbarkeitsdatum (MM/YY)</label>
															<div class="col-sm-6">
													...
													<div class="form-group clearfix">
															<div class="col-sm-12">
																	<input type="submit" name="METHOD" value=" &raquo; Zahlen Sie jetzt mit Kreditkarte! " class="btn btn-danger pull-right">
															</div>
													</div>
											</div>
										</form>
