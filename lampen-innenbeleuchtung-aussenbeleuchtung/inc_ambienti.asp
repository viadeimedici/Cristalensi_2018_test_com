...
if gr_rs.recordcount>0 then
  Titolo_1=gr_rs("Titolo_1_de")
  Titolo_2=gr_rs("Titolo_2_de")
  Url=gr_rs("Url_de")
  Title=gr_rs("Title_de")
  Description=gr_rs("Description_de")
  Descrizione=gr_rs("Descrizione_de")
  Img=gr_rs("Img")
...
<body>
    ...
    <div class="container content">
        ...
        <div class="col-xl-12">
            <ol class="breadcrumb">
                <li><a href="/de/" title="CRISTALENSI Online Verkauf von Lampen"><i class="fa fa-home"></i></a></li>
            ...
            <div class=" top-buffer">
                <nav class="navbar hidden-xs">
                    ...
                    <ul class="list-unstyled side-list">
                        ...
                        %>
                        <li><a href="/lampen-innenbeleuchtung-aussenbeleuchtung/<%=Url%>" title="<%=Titolo_1%>" <%if pkid=pkid_ambiente then%>class="active"<%end if%>><%=Titolo_1%></a></li>
                        <%
                        tip_rs.movenext
                        loop
                        %>
        ...
        <div class="col-md-9">
            <div class="row top-buffer">
                ...
                sql = "SELECT * FROM Prodotti WHERE ((FkNewAmbiente LIKE '%"&PosizioneAmbiente&"%') and (Offerta=0 or Offerta=2) and (Len(Titolo_DE)>0)) ORDER BY "&ordine&""
