...
<head>
    ...
    <meta property="og:description" content="<%if Len(Description)>0 then%><%=Description%><%else%>Bei Cristalensi finden Sie eine grosse Auswahl an <%=Titolo_1%>: Online-Rabatte fur alle Beleuchtungsprodukte<%end if%>">
    ...
    <link rel="canonical" href="https://www.cristalensi.it/lampen-innenbeleuchtung-aussenbeleuchtung/<%=toUrl%>"/>
            ...
            <div class=" top-buffer">
                <nav class="navbar hidden-xs">
                    ...
                    <ul class="list-unstyled side-list">
                        ...
                        %>
                        <li><a href="/lampen-innenbeleuchtung-aussenbeleuchtung/<%=Url%>" title="<%=Titolo_1%>"><%=Titolo_1%></a></li>
                        <%
                        tip_rs.movenext
                        loop
                        %>
