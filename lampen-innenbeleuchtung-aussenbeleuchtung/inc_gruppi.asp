    ...
    <div class="container content">
                ...
                <nav class="navbar hidden-xs">
                    ...
                    <ul class="list-unstyled side-list">
                        ...
                        Do While not tip_rs.EOF
                          Titolo_1_menu=tip_rs("Titolo_1_de")
                          Titolo_2_menu=tip_rs("Titolo_2_de")
                          Url_menu=tip_rs("Url_de")
                          Title_menu=tip_rs("Title_de")
                          'Description=tip_rs("Description")
                          'Descrizione=tip_rs("Descrizione")
                        %>
                        <li><a href="/lampen-innenbeleuchtung-aussenbeleuchtung/<%=Url_menu%>" title="<%=Titolo_1_menu%>"><%=Titolo_1_menu%></a></li>
                        <%
                        tip_rs.movenext
                        loop
                        %>
        ...
        <div class="col-md-9">
            <div class="row top-buffer">
                ...
                sql = "SELECT * FROM Prodotti WHERE (FkNewGruppo="&pkid_gruppo&" and (Offerta=0 or Offerta=2) and (Len(Titolo_DE)>0)) ORDER BY "&ordine&""
                      ...
                      <div class="info">
                          <div class="row">
                              <div class="price-details col-md-6">
                                  ...
                                  <p class="details"><span>code: <b><%=codicearticolo%></b></span><span>marke: <b><a href="<%=url_produttore%>" title="<%=produttore%>"><%=produttore%></a></b></span></p>
                ...
                <div class="col-lg-12">
                    <nav aria-label="Page navigation center-block">
                        <ul class="pagination">
                            ...
                            <% if p > 1 then %>
                            <li>
                                <a href="/lampen-innenbeleuchtung-aussenbeleuchtung/<%=toUrl%>?p=<%=p-1%>&cat=<%=cat%>&FkProduttore=<%=FkProduttore%>&order=<%=order%>#inizioelenco" aria-label="Vorher">
                            ...
                            <li>
                                <a href="/lampen-innenbeleuchtung-aussenbeleuchtung/<%=toUrl%>?p=<%=p+1%>&cat=<%=cat%>&FkProduttore=<%=FkProduttore%>&order=<%=order%>#inizioelenco" aria-label="Nachher">
