...
if tr_rs.recordcount>0 then
  Titolo_1=tr_rs("Titolo_1_de")
  Titolo_2=tr_rs("Titolo_2_de")
  Url=tr_rs("Url_de")
  Title=tr_rs("Title_de")
  Description=tr_rs("Description_de")
  Descrizione=tr_rs("Descrizione_de")
  Img=tr_rs("Img")
    ...
    <div class="container content">
        <div class="col-xl-12">
            <ol class="breadcrumb" itemtype="http://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemtype="http://schema.org/ListItem"><a href="/" itemprop="item" title="CRISTALENSI Online Verkauf von Lampen"><span itemprop="name"><i class="fa fa-home"></i></span></a><meta itemprop="position" content="1" /></li>
        ...
        <div class="col-md-9">
            <div class="row top-buffer">
                ...
                sql = "SELECT * FROM Prodotti WHERE (FkNewTipologia="&pkid_tipologia&" and (Offerta=0 or Offerta=2) and (Len(Titolo_DE)>0)) ORDER BY "&ordine&""
